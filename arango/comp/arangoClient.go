...
func (ac *ArangoClient) NewClient() (client driver.Client, err error) {
...
func (ac *ArangoClient) getAuth() driver.Authentication {
	switch ac.AuthType {
	case "basic":
...
func (ac *ArangoClient) replaceEnv() (err error) {
